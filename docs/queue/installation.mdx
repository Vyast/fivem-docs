...
3. Configure the queue system to your servers needs by following all the steps here: **[Configuration Guide](./configuration)**
...
7. Start your server and ensure that v-queue is started and working. If you run into any issues, please be sure to visit and read **[Common Issues](../issues)** before opening a support ticket in discord.
